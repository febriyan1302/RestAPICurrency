...
CREATE TABLE `tb_currency` (
  ...
  `c_from` varchar(10) DEFAULT NULL,
  `c_to` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tb_currency` (`id`, `rate`, `tanggal`, `c_from`, `c_to`) VALUES (1,14400,'2018-08-16','IDR','USD');
...
-- Dump completed on 2018-08-16 15:23:47
